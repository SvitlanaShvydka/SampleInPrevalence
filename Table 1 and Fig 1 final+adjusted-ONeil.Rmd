...
# Define prevalence values to iterate over (as percentages)
...
# Function to calculate Wilson score interval precision (half-width)
...
# Function to calculate Wald interval precision (half-width)
...
for (p_percent in prevalence_values) {
  ...
  # -----------------------------------------------------------------------
  # --- 1. Calculate n where D≤P or D≤100-P with 95% probability (Wald + Wilson Adj) ---
  # -----------------------------------------------------------------------
  ...
  # Calculate precision for result_np5 using Wilson and Wald
  ...
  # Calculate Wilson precision for result_pneq0
...
# Function to calculate adjusted n with FPC
...
# Function to calculate precision from Wilson interval
